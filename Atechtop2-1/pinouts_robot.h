...
#define  TEMP_SENSOR_ID     0x03           // temperature sensor   using in AtechTop ******************************************
#define  RANGE_LEFT_ID      0x04           // ultrasonic range 1 is left
#define  RANGE_RIGHT_ID     0x05           // ultrasonic range 2 is right
#define  CLEAN_BATTERY_ID   0x06           // Arduino battery, this original named "CLEAN_BATTERY_ID", for now be changed to "PULSE_SENSOR_ID" in AtechTop ****************************************** 
#define  DIRTY_BATTERY_ID   0x07            // DC and servo motors battery, this original named "DIRTY_BATTERY_ID", for now be changed to "OXIMETER_SENSOR_ID" in AtechTop ******************************************
...
// aTechTop definitions
#define  OXIMETER_SENSOR_ID    0x06
#define  PULSE_SENSOR_ID       0x07
